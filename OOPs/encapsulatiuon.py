#bundle data and method(behaviour and attribute)into single unit,
#every attribute must be private and every attribute must have setters and getters in encapsulation
